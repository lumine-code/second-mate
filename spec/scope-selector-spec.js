...
describe("ScopeSelector", function () {
  ...
  describe(".toCssSyntaxSelector()", () => {
    it("converts the TextMate scope selector to a CSS selector prefixing it `syntax--`", function () {
      expect(new ScopeSelector("a b c").toCssSyntaxSelector()).to.eql(
      ...
      expect(new ScopeSelector("a & -b").toCssSyntaxSelector()).to.eql(
        ".syntax--a:not(.syntax--b)",
      );
      expect(new ScopeSelector("a | b").toCssSyntaxSelector()).to.eql(".syntax--a, .syntax--b");
      expect(new ScopeSelector("a - (b.c d)").toCssSyntaxSelector()).to.eql(
        ".syntax--a:not(.syntax--b.syntax--c .syntax--d)",
      );
      expect(new ScopeSelector("a, b").toCssSyntaxSelector()).to.eql(".syntax--a, .syntax--b");
