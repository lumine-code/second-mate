...
class Assertion {
  ...
  eql(expected) {
    this._assert(deepEql(this.target, expected));
    return this;
  }
  equal(expected) {
  ...
  lengthOf(n) {
    this._assert(this.target != null && this.target.length === n);
    return this;
  }
  ...
  // terminal getters
  get ok() {
    this._assert(!!this.target);
    return this;
  }
  get true() {
    this._assert(this.target === true);
    return this;
  }
  get false() {
    this._assert(this.target === false);
    return this;
  }
  get null() {
    this._assert(this.target === null);
    return this;
  }
  get undefined() {
    this._assert(this.target === undefined);
    return this;
  }
  get exist() {
    this._assert(this.target != null);
  ...
  get empty() {
    this._assert(this.target != null && this.target.length === 0);
    return this;
  }
